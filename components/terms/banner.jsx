                ...
                <div className="row align-items-center">
                    <div className="col-lg-10 col-md-10">
                        <div className="frontpage-banner-content">
                            <h2 className="hero-title w-800 aos-item" data-aos="fade-left" data-aos-duration="300" data-aos-once="true">Terms & Conditions</h2>
                            
                            <div className="hero-desc aos-item" data-aos="fade-left" data-aos-duration="400" data-aos-once="true">
                                <p>Understanding Our Rules and Policies</p>
                            </div>
                        </div>
                    </div>
                </div>
